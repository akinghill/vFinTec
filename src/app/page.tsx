    ...
    <div className="font-sans grid grid-rows-[20px_1fr_20px] items-center justify-items-center min-h-screen p-8 pb-20 gap-16 sm:p-20">
      <main className="flex flex-col gap-[32px] row-start-2 items-center sm:items-start">
        ...
        <div className="flex gap-4 items-center flex-col sm:flex-row">
          ...
          <a
            className="rounded-full border border-solid border-border transition-colors flex items-center justify-center bg-background hover:bg-muted text-foreground hover:text-foreground font-medium text-sm sm:text-base h-10 sm:h-12 px-4 sm:px-5 w-full sm:w-auto md:w-[158px]"
